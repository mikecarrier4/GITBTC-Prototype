...
class User:
    ...
    def __init__ (self, name, phone,  rusername,  rpassword, mfa):
        self.name = name
        self.phone = '+' + phone
    ...
    def connect_to_RobinHood(self): #Console Statment 1
        login = r.login(self.rusername, self.rpassword, store_session = False, mfa_code = self.mfa)
    ...
    def logging_off_Robinhood(self): # Console Statment 2
        r.authentication.logout()
        #Enter Kill Swtich Here
        print('log off')
